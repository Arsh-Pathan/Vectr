...
export default function GitHubConnectButton({ className = "" }) {
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center space-x-3 bg-gray-900 text-white font-medium py-2 px-4 rounded-full hover:bg-gray-800 transition-colors focus:ring-2 focus:ring-offset-1 focus:ring-gray-900 ${className}`}
    >
